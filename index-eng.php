						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" role="menu">
    							<li><a  href="CLASSIC/English/exam.html" class="dropdown-item"><span style="text-transform: none;"> Classic</span></a></li>
   								<li><a href="English/exam.html" class="dropdown-item"><span style="text-transform: none;"> Tie</span></a></li>
    							<li><a href="English/cadets exam.html" class="dropdown-item"><span style="text-transform: none;"> Cadets</span></a></li>
  								</ul>

							</li>
						<li><a href="English/support.html">Support</a></li>
						<!-- <li><a href="price_list.html">Price List</a></li> -->
						
						<li><a href="English/centres.html" >Approved Centres</a></li>
						<li><a href="English/centre_support.html">Centre Support</a></li>
				...
				<div class="col-md-7 text-right">
					<div class="block wow fadeInUp" data-wow-delay=".3s">
						...
						<p class="wow fadeInUp animated" data-wow-delay=".6s"
							...
							Gatehouse Awards Ltd is an industry leading Awarding Organisation recognised by the<br>
							<font face="Century Gothic" size="4px" style="font-weight: bold;"> <i>Office of Qualifications and Examinations Regulation, England (Ofqual)</i> </font>
							 and other recognition bodies worldwide, including Malta, Italy and Greece.<br>

With a range of English language and vocational qualifications available, we work closely with schools,
colleges, employers and industry-representatives to develop and offer their innovative and creative 
qualifications across the UK and abroad.

<br><br>We understand the needs of our centres and the employers we work with, supporting them
 to make the most of the education and training they can offer their learners and employees.<br>
  In short, we can 'make it happen'.
				...
				<div class="row">
						<div class="block wow fadeInUp djape" data-wow-delay=".3s">
							<a
