				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.php"> <img src="../images/gatehouse-logo.png"
							alt="NAISA logo" style="height: 84px;">
						</a> <a href="http://www.tie-italy.net/"> <img
							src="../images/TIE-LOGO.png" alt="NAISA logo" style="height: 64px;">
						</a>
					</div>
					<!-- /logo -->
				</div>
			...
			<div class="row">
				<div class="block wow fadeInUp" data-wow-delay=".3s">
					<h1 class="wow fadeInUp animated cd-headline slide"
						...
						<span>Upcoming TIE Webinars:</span>
					</h1>
					...
					<span style="color: #000; font-size: medium;">Regulations and forms available on Support page. </span><br>
				</div>
			</div>
		</div>
	</section>
